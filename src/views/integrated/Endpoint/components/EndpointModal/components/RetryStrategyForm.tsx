...
const RetryStrategyForm: React.FC<RetryStrategyFormProps> = memo(({ useExponentialBackoff }) => {
  return (
    <>
      ...
      <Form.Item label="重试次数" tooltip="最大重试次数">
        <Space.Compact className="w-full">
          <Form.Item
            name={['config', 'retryStrategy', 'maximumRedeliveries']}
            noStyle
      ...
      <Form.Item label="初始延迟" tooltip="初始延迟时间">
        <Space.Compact className="w-full">
          <Form.Item
            name={['config', 'retryStrategy', 'redeliveryDelay']}
            noStyle
      ...
      <Form.Item label="退避倍数" tooltip="退避倍数">
        <Space.Compact className="w-full">
          <Form.Item
            name={['config', 'retryStrategy', 'backOffMultiplier']}
            noStyle
      ...
      <Form.Item label="最大延迟" tooltip="最大延迟时间">
        <Space.Compact className="w-full">
          <Form.Item
            name={['config', 'retryStrategy', 'maximumRedeliveryDelay']}
            noStyle

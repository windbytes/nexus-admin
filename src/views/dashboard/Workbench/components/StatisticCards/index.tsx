...
// 单个统计卡片组件 - 使用 memo 优化
const StatisticCard = memo<{ item: StatisticData; index: number }>(({ item, index }) => {
  // 使用 useMemo 缓存样式计算
    ...
    <div className={styles['statisticCard']}>
      ...
      >
        ...
        <div 
          ...
          style={{ background: cardStyles.background }}
        />
        ...
        <div className="absolute inset-0 opacity-20">
          <div 
            ...
            style={{ background: cardStyles.backgroundSecondary }}
          />
          <div 
            className={`${styles['decorativeCircle']}`}
            style={{ background: cardStyles.backgroundSecondary2 }}
          />
        </div>
        ...
        <div 
          ...
          style={{ background: cardStyles.borderGradient }}
        />
        ...
        <div 
          ...
          style={{ background: cardStyles.glowEffect }}
        />
      </Card>
    </div>
  );

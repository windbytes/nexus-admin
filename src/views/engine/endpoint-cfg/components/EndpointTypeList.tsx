...
import { Button, Card, Input, message, Space, Table, Tag, Tooltip } from 'antd';
...
const EndpointTypeList: React.FC<EndpointTypeListProps> = ({
  ...
  const getCheckboxProps = (record: EndpointTypeConfig) => ({

...
import { App, Button, Col, Form, Input, Radio, Row, Switch } from 'antd';
...
const RadioConfig: React.FC<ComponentConfigProps> = ({ value = {}, onChange }) => {
  ...
  return (
    <div>
      ...
      >
        <Form.Item name="optionType" label="选项样式" tooltip="单选框选项样式">
          <Radio.Group>
        ...
        <Form.Item name="disabled" label="禁用状态" valuePropName="checked" tooltip="是否禁用单选框组">
          <Switch />
        </Form.Item>
      </Form>
